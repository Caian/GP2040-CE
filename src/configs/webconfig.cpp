...
std::string setAddonOptions()
{
    ...
    docToPin(addonOptions.i2cInputExpansionSDAPin, doc, "i2cInputExpansionSDAPin");
    docToPin(addonOptions.i2cInputExpansionSCLPin, doc, "i2cInputExpansionSCLPin");
    docToValue(addonOptions.i2cInputExpansionBlock, doc, "i2cInputExpansionBlock");
    docToValue(addonOptions.i2cInputExpansionSpeed, doc, "i2cInputExpansionSpeed");
    docToValue(addonOptions.i2cInputExpansionAddress, doc, "i2cInputExpansionAddress");
	...
	docToValue(addonOptions.I2CInputExpansionEnabled, doc, "I2CInputExpansionEnabled");
...
std::string getAddonOptions()
{
    ...
    writeDoc(doc, "i2cInputExpansionSDAPin", addonOptions.i2cInputExpansionSDAPin == 0xFF ? -1 : addonOptions.i2cInputExpansionSDAPin);
    writeDoc(doc, "i2cInputExpansionSCLPin", addonOptions.i2cInputExpansionSCLPin == 0xFF ? -1 : addonOptions.i2cInputExpansionSCLPin);
    writeDoc(doc, "i2cInputExpansionBlock", addonOptions.i2cInputExpansionBlock);
    writeDoc(doc, "i2cInputExpansionSpeed", addonOptions.i2cInputExpansionSpeed);
    writeDoc(doc, "i2cInputExpansionAddress", addonOptions.i2cInputExpansionAddress);
    writeDoc(doc, "i2cInputExpansionAnalogMap", addonOptions.i2cInputExpansionAnalogMap.data());
    writeDoc(doc, "i2cInputExpansionDigitalMap", addonOptions.i2cInputExpansionDigitalMap.data());
    ...
    writeDoc(doc, "I2CInputExpansionEnabled", addonOptions.I2CInputExpansionEnabled);
